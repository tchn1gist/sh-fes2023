              ...
              <div class="collapse navbar-collapse " id="navbarSupportedContent">
                <ul class="navbar-nav me-auto mb-3 mb-lg-0 ">
                  ...
                  <li class="nav-item dropdown mx-2 btn-group">
                    <button type="button" class="btn nav-link" id="navbarDropdown" role="button"  aria-expanded="false" onclick="jump_to_club()" data-toggle="dropdown">部活動展示</button>
                    <button type="button" class="btn dropdown-toggle dropdown-toggle-split" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false"　id="navbarDropdown" role="button" data-bs-toggle="dropdown">
                        <span class="sr-only"></span>
                    </button>
                    <ul class="dropdown-menu" style="box-shadow: 1px 10px 10px -5px rgba(0,0,0,0.5);" aria-labelledby="navbarDropdown">
                  ...
                  <li class="nav-item dropdown mx-2 btn-group">
                    <button type="button" class="btn nav-link" id="navbarDropdown" role="button"  aria-expanded="false" onclick="jump_to_club()" data-toggle="dropdown">各教室展示</button>
                    <button type="button" class="btn dropdown-toggle dropdown-toggle-split" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false"　id="navbarDropdown" role="button" data-bs-toggle="dropdown">
                        <span class="sr-only"></span>
                    </button>
                    <ul class="dropdown-menu" style="box-shadow: 1px 10px 10px -5px rgba(0,0,0,0.5);" aria-labelledby="navbarDropdown">
                  ...
                  <li class="nav-item dropdown mx-2 btn-group">
                    <button type="button" class="btn nav-link" id="navbarDropdown" role="button"  aria-expanded="false" onclick="jump_to_club()" data-toggle="dropdown">実行委員より</button>
                    <button type="button" class="btn dropdown-toggle dropdown-toggle-split" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false"　id="navbarDropdown" role="button" data-bs-toggle="dropdown">
                        <span class="sr-only"></span>
                    </button>
                    <ul class="dropdown-menu" style="box-shadow: 1px 10px 10px -5px rgba(0,0,0,0.5);" aria-labelledby="navbarDropdown">
